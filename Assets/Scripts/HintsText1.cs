...
public class HintsText1 : MonoBehaviour
{
    ...
    string hint1 = "The sign says: To win, you need all 3 artifacts to activate the sacret ladder. ";
    string hint2 = "The sign says: All three artifacts are collected! Ladder now activated.";
